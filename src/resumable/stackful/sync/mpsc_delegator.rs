...
struct Inner<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
    queue: Q,
...
unsafe impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> Send for Inner<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {}
unsafe impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> Sync for Inner<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {}

impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C> + Default> Inner<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
    fn new(consumer: C) -> Self where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
        Inner {
            queue: Q::default(),
...
impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> Inner<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
...
impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> Drop for Inner<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
    fn drop(&mut self) where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
        self.lock_wait();
...
pub struct Producer<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>>(Arc<Inner<S, C, Q>>) where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable;

impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> Clone for Producer<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
    fn clone(&self) -> Self where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
        Producer(Arc::clone(&self.0))
    }
}

impl<S: StackfulSchedulerSystem + ThreadSystem, C: DelegatorConsumer<S>, Q: SyncQueue<S, C>> Producer<S, C, Q> where <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable {
...
where
    ...
    Q: SyncQueue<S, C> + Default + 'static, <S as SchedulerSystem>::Desc: StackfulTaskDesc + WakerTaskDesc, <S as ThreadSystem>::SuspendedThread: StackfulOnlyResumable
{
